...
fun getList() :HashMap<Genre, List<MovieDetail>> {
    ...
    val action = arrayListOf(
        ...
        "Joss Whedon","Matthew McConaughey, Anne Hathaway, Jessica Chastain",R.drawable.avengers,R.drawable.avengers_detail,"8.0","2012 2h 23m", false),
    ...
    val horror = arrayListOf(
        MovieDetail("Get Out","Horror","A young African-American visits his white girlfriend's parents for the weekend, where his simmering uneasiness about their reception of him eventually reaches a boiling point.",
            "Jordan Peele","Daniel Kaluuya, Allison Williams, Bradley Whitford ",R.drawable.getout,R.drawable.getout_detail,"8.2","2017 1h 44m", false),
        ...
        "Frank Darabont, Angela Kang"," Andrew Lincoln, Norman Reedus, Melissa McBride",R.drawable.twd,R.drawable.twd_detail,"8.2","2006 2h 1m", false),
    ...
    val scifi = arrayListOf(
        MovieDetail("Inception","Sci-Fi","A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a C.E.O.",
            "Christopher Nolan"," Leonardo DiCaprio, Joseph Gordon-Levitt, Elliot Page",R.drawable.inception,R.drawable.inception_detail,"8.8","2010 2h 28m", false),
